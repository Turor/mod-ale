...
ALERegister<Player> PlayerMethods[] =
{
    ...
    { "GetRuneCooldown", &LuaPlayer::GetRuneCooldown },
    ...
    { "DropTalentRank", &LuaPlayer::DropTalentRank },
    { "GetClasslessTalentRank", &LuaPlayer::GetClasslessTalentRank },
    { "RequestSpellSave", &LuaPlayer::RequestSpellSave },
    { "GetClasslessPetTalentTabs", &LuaPlayer::GetClasslessPetTalentTabs },
    { "GetClasslessPetFreePoints", &LuaPlayer::GetClasslessPetFreePoints },
    { "GetClasslessPetTalentRank", &LuaPlayer::GetClasslessPetTalentRank },
    { "ClasslessPetLearnTalent", &LuaPlayer::ClasslessPetLearnTalent },
    { "ClasslessPetUnlearnTalent", &LuaPlayer::ClasslessPetUnlearnTalent },
    { "ClasslessPetCastSpell", &LuaPlayer::ClasslessPetCastSpell },
    { "ClasslessPetToggleAutocast", &LuaPlayer::ClasslessPetToggleAutocast },
    { "GetClasslessPetAutocast", &LuaPlayer::GetClasslessPetAutocast },
    { "GetClasslessPetAutocastMaps", &LuaPlayer::GetClasslessPetAutocastMaps },
    { "GetClasslessSpellTrainCost", &LuaPlayer::GetClasslessSpellTrainCost },
    { "ChargeClasslessSpellTrainCost", &LuaPlayer::ChargeClasslessSpellTrainCost },
